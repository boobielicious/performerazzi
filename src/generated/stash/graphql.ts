...
export type PerformerFragmentFragment = {
  __typename?: 'Performer'
  id: string
  name: string
  measurements?: string | null
  aliases: Array<string>
  boobsType?: string | null
  isFavorite: boolean
  imageUrl?: string | null
  stashServices: Array<{ __typename?: 'StashID'; endpoint: string; id: string }>
} & { ' $fragmentName'?: 'PerformerFragmentFragment' }

export type AllPerformersQueryVariables = Exact<{ [key: string]: never }>

export type AllPerformersQuery = {
  __typename?: 'Query'
  allPerformers: Array<{ __typename?: 'Performer'; id: string; name: string; imageUrl?: string | null }>
}
...
export const PerformerFragmentFragmentDoc = new TypedDocumentString(
  `
  ...
  stashServices: stash_ids {
    ...
    `,
  { fragmentName: 'PerformerFragment' }
) as unknown as TypedDocumentString<PerformerFragmentFragment, unknown>
